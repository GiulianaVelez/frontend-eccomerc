...
function Dashboard() {
  ...
  return (
    ...
    <div className='p-8 grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='p-6 bg-rose-400 shadow-md rounded-lg border border-gray-200'>
           <h2 className="text-xl font-bold text-gray-900 mb-4">CREAR PRODUCTO</h2>
        ...
        <div className='p-6 bg-rose-400 shadow-md rounded-lg border border-gray-200'>
           ...
           <p className="text-gray-700 mb-6">Añadir nuevos usuarios</p>
           <Link
        ...
        <div className='p-6 bg-rose-400 shadow-md rounded-lg border border-gray-200'>
           <h2 className="text-xl font-bold text-gray-900 mb-4">CREAR CATEGORIA</h2>
           <p className="text-gray-700 mb-6">Añadir nuevas categorias</p>
           <Link
        ...
        <div className='p-6 bg-rose-400 shadow-md rounded-lg border border-gray-200'>
           <h2 className="text-xl font-bold text-gray-900 mb-4">CREAR ROL</h2>
           <p className="text-gray-700 mb-6">Añadir nuevos Roles</p>
           <Link
              to="/admin/rol/nuevo"
